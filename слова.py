import random
LETTER_SCORES = {
    "А" : 1, "Б" : 3, "В" : 4, "Г" : 2, "Д" : 3, "Е" : 1, "Ё" : 5, "Ж" : 4, "З" : 3, "И" : 1, "Й" : 7, "К" : 2, "Л" : 3, "М" : 2, "Н" : 4, "О" : 1, "П" : 3,
    "Р" : 4, "С" : 3, "Т" : 5, "У" : 2, "Ф" : 8, "Х" : 6, "Ц" : 7, "Ч" : 4, "Ш" : 8, "Щ" : 9, "Ъ" : 10, "Ы" : 3, "Ь" : 6, "Э" : 5, "Ю" : 3, "Я" : 4
}
...
def get_word_with_letter(letter):
    ...
    while win == False:
        ...
        if letter != word[0].upper():
            print(f"Слово должно начинаться на букву: {letter}, попробуйте заново.")
        else:
            win = True
    return word
